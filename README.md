...
Proxmox Linux Desktop Client


An app for the linux desktop to interact with a Proxmox server. With Proxmox-LDC you have the following features

* Connect to multiple Proxmox machines
